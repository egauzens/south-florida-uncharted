    ...
    <el-row class="row mb-16">
      ...
      <el-col class="text-column">
        ...
        <el-button class="mt-8">
          <a :href="`mailto:dgauzens@gmail.com?subject=${card.name}%20Trip&body=Hi!%20I%20would%20like%20to%20book%20a%20${card.name}%20Trip%20on%20<insert%20date%20of%20booking>%20for%20<insert%20number%20of%20people>%20person(s).`">
