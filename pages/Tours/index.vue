<template>
  <div>
    <section class="header-section mb-16">
      <div class="heading2"><em>Let's go exploring!</em></div>
      <div class="heading1"><strong>Eco Tours</strong></div>
    </section>
    ...
    <div class="m-16">
      <div class="heading1 mb-8">Included: 
        <span class="heading2">Kayaks, SUP, Paddle, Mask, Snorkle, Fins, PFD, GoPro rental available for additional charge.</span>
      </div>
